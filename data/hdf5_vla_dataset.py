...
class HDF5VLADataset:
    ...
    def fill_in_state(self, values):
        UNI_STATE_INDICES = (
            [STATE_VEC_IDX_MAPPING[f"left_eef_{axis}"] for axis in ['x', 'y', 'z', 'rx', 'ry', 'rz']] +
            [STATE_VEC_IDX_MAPPING["left_roll"], STATE_VEC_IDX_MAPPING["left_pitch"], STATE_VEC_IDX_MAPPING["left_yaw"]] +
            [STATE_VEC_IDX_MAPPING["left_gripper"]] +
            [STATE_VEC_IDX_MAPPING[f"right_eef_{axis}"] for axis in ['x', 'y', 'z', 'rx', 'ry', 'rz']] +
            [STATE_VEC_IDX_MAPPING["right_roll"], STATE_VEC_IDX_MAPPING["right_pitch"], STATE_VEC_IDX_MAPPING["right_yaw"]] +
            [STATE_VEC_IDX_MAPPING["right_gripper"]]
        )
